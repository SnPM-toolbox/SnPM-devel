...
DesHelp = {'',...
	  ...
	  '',...
	  'Number of permutations.  The number of possible permutations with this design is n! (read "n factorial") where n is the number of subjects.  In Matlab, use the GAMMA command to check the number of permutations, as in ',...
	  '    n=10;gamma(n+1)',...
