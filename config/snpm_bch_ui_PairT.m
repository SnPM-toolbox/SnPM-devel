...
DesFile = mfilename;
DesHelp = {'Create design and permutation matrix appropriate for multi-subject, two condition no replication design, where the condition labels have been applied to the subjects in a nonrandomized fashion.',...
    '',...
