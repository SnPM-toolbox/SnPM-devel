...
DesFile = mfilename;
DesHelp = {'',...
        'Create design and permutation matrix appropriate for two group, two condition interaction analyses where there is just *one* scan per condition.  Only the interaction between activation and group is examined. Use snpm_MSA2x to examine intragroup (main) effects.',...
        '',...
