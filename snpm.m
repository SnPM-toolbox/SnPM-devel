...
elseif strcmp(lower(Action),lower('CreateMenuWin'))
    ...
    h1_1  = uimenu(h1,...
        ...
        'Separator',	'off',...
        'Tag',		'TwoSampTss',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.TwoSampTss'');',...
        'HandleVisibility','on');
    h1_2  = uimenu(h1,...
        'Label',	'SingleSub: Simple Regression (correlation); single covariate of interest',...
        'Separator',	'off',...
        'Tag',		'Corr1S',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.Corr1S'');',...
        'HandleVisibility','on');
    h1_3  = uimenu(h1,...
        'Label',	'MultiSub: One Sample T test on diffs/contrasts',...
        'Separator',	'off',...
        'Tag',		'OneSampT',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.OneSampT'');',...
        'HandleVisibility','on');
    h1_4  = uimenu(h1,...
        'Label',	'MultiSub: Simple Regression; 1 covariate of interest',...
        'Separator',	'off',...
        'Tag',		'Corr',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.Corr'');',...
        'HandleVisibility','on');
    h1_5  = uimenu(h1,...
        'Label',	'MultiSub: Paired T test; 2 conditions, 1 scan per condition',...
        'Separator',	'off',...
        'Tag',		'PairT',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.PairT'');',...
        'HandleVisibility','on');
    h1_6  = uimenu(h1,...
        'Label',	'Within Subject ANOVA, k diffs/contrasts per subject',...
        'Separator',	'off',...
        'Tag',		'ANOVAwithinS',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.ANOVAwithinS'');',...
        'HandleVisibility','on');
    h1_7  = uimenu(h1,...
        'Label',	'2 Groups: Two Sample T test; 1 scan per subject',...
        'Separator',	'off',...
        'Tag',		'TwoSampT',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.TwoSampT'');',...
        'HandleVisibility','on');
    h1_8  = uimenu(h1,...
        'Label',	'2 Groups: Test diff of response; 2 conditions, 1 scan per condition',...
        'Separator',	'off',...
        'Tag',		'TwoSampPairT',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.TwoSampPairT'');',...
        'HandleVisibility','on');
    h1_9  = uimenu(h1,...
        'Label',	'Between group ANOVA; 1 scan per subject',...
        'Separator',	'off',...
        'Tag',		'ANOVAbtwnS',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Design.ANOVAbtwnS'');',...
        'HandleVisibility','on');
    h2  = uimenu(h0,...
        'Label',	'Compute',...
        'Separator',	'off',...
        'Tag',		'Compute',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.snpm_bch_cp'');',...
        'HandleVisibility','on');
    h3  = uimenu(h0,...
        'Label',	'Inference',...
        'Separator',	'off',...
        'Tag',		'Inference',...
        'CallBack','spm_jobman(''interactive'','''',''spm.tools.cfg_snpm.Infer'');',...
        'HandleVisibility','on');
