function tfce_estimate = snpm_cfg_estimate
% Configuration file for snpm estimate
%_______________________________________________________________________
% Copyright (C) 2008 Wellcome Trust Centre for Neuroimaging ??

% $Id: tbx_cfg_tfce_estimate.m 62 2013-10-01 14:29:17Z gaser $
...
tfce_estimate.tag      = 'cp';
tfce_estimate.name     = 'Compute';
tfce_estimate.val      = {spmmat mask conspec openmp};
tfce_estimate.help     = {''};
tfce_estimate.prog     = @snpm_run_estimate;
