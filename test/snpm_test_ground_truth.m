...
switch buttonName,
    ...
    case 'yes',
        ...
        %             , 'onesample_cov3', 'onesample_cov'
        %             } ;
        
        testTwoSample = {'twosample_var'} %{'twosample_ancova'} %{, ...
        ...
        testOneSubTwoSample = {}% 'onesub_twocondrepl_1_other_design', 'twosample_proportional_global_user'...
        %               'onesub_twocondrepl_1', 'onesub_twocondrepl_var'};
        
        testANOVAbetw = {'ANOVAbetween_var'}%{'ANOVAbetween_approx'};% 'ANOVAbetween_1' 'ANOVAbetween_allzero'
        testANOVAwithin = {'multisub_withinsubanova_var'}%{, 'multisub_withinsubanova_approx'}%{'multisub_withinsubanova_1'}
        testPaired2cond = {'multisubpaired2cond_var'}%'multisubpaired2cond_chgorder','multisubpaired2cond_approx','multisubpaired2cond_1', }
        testMultiSubSimpleReg = {'multisubsimpleregression_var'}%, 'multisubsimpleregression_approx'}%'multisubsimpleregression_1'
        testOneSubRegression = {'onesub_regression_var'}%'onesub_regression_approx' onesub_regression_1 
        testTwoSampTwoCond = {'twosample_twocond_var'}%'twosample_twocond_cov3'}%'twosample_twocond_1','twosample_twocond_cov', 'twosample_twocond_cov3''twosample_twocond_chgorder','twosample_twocond_approx''twosample_twocond_1', 
