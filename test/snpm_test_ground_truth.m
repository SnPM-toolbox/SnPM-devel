...
switch buttonName,
    ...
    case 'yes',
        ...
        testOneSample = {'onesample_propscaling'} %{'onesample_approx', 'onesample_var', 'onesample_cov3', 'onesample_cov', 'onesample_cluster_predefined', 'onesample_cluster'} % 'onesample_1'};
