...
classdef test_onesub_regression < matlab.unittest.TestCase & generic_test_snpm
    ...
    methods (TestMethodSetup)
        function create_basis_matlabbatch(testCase)
            ...
            testCase.matlabbatch{1}.cfg_snpm.Design.Corr1S.P = {
            ...
            testCase.matlabbatch{1}.cfg_snpm.Design.Corr1S.CovInt = [1 2 0 -1 5 4 3 3 1 -2 0 1.5];
            testCase.matlabbatch{1}.cfg_snpm.Design.Corr1S.xblock = 2;
        end
    end
    ...
    methods (Test)
        ...
        function test_onesub_regression_var(testCase)
            ...
            testCase.matlabbatch{1}.cfg_snpm.Design.Corr1S.vFWHM = [8.5 8.5 8.5];
        end
        ...
        function test_onesub_regression_approx(testCase)
            ...
            testCase.matlabbatch{1}.cfg_snpm.Design.Corr1S.nPerm = 50;
        end
    end
    ...
    methods (TestMethodTeardown)
        function complete_batch(testCase)
            ...
            testCase.matlabbatch{1}.cfg_snpm.Design.Corr1S.dir = {testCase.batchResDir};
        end
    end
end